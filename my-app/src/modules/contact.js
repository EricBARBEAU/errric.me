        ...
        <div className="contact-container">
          ...
          <div className="contact-block">
            ...
            <div className="ctas">
              ...
              <a href="https://cdn.jsdelivr.net/gh/EricBARBEAU/errric.me@master/EricBARBEAU_Resume2025.pdf" target="_blank" rel="noreferrer" className="contact-btn contact-btn-2">my resume</a>
            </div>
          </div>
